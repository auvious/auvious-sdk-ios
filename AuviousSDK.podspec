...
Pod::Spec.new do |s|
  s.name             = 'AuviousSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AuviousSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Epi Vou/AuviousSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Epi Vou' => 'pimenas@gmail.com' }
  s.source           = { :git => 'https://github.com/Epi Vou/AuviousSDK.git', :tag => s.version.to_s }
